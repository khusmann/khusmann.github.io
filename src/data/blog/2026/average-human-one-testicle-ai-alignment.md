...
My graduate work was in human development and family studies, where we spent a lot of time thinking about what it means to model and predict human behavior. There's a inherent tradeoff in this space that's well-known in behavioral science but I haven't seen touched on in discussions about AI -- and I think it's fundamental to the problem of shallow alignment.
