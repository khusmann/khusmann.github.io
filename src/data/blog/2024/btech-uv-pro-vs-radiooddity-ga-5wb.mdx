...
That said, even though they're built with the same hardware (BTech support confirmed they all have the same PCB), that doesn't mean they're _exactly_ the same. I first got the RadioOddity GA-5WB, then about a month later the UV-Pro came out, so I figured I'd get a UV-Pro as well to compare the radios side-by-side. In my testing I found a number of differences between the radios, including the accessories they provide, their transmit power, firmware capabilities, and GPS performance.
...
The UV-Pro also retails cheaper than the GA-5WB and VR-N76, and is available on Amazon with fast shipping from USA-based warehouses (whereas the GA-5WB and VR-N76 take longer to ship and are harder to return because they are shipped directly from China)
