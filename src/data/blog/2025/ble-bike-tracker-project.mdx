...
The stationary bike in question is a [Flexispot from Amazon](https://www.amazon.com/FLEXISPOT-Removable-Exercise-Capacity-Stationary/dp/B0FNVMWXDK) (~$230 if you catch it on sale). It has a desk so it's nice to pedal on to keep moving while working, and has a magnetic resistance system so it runs very quiet.
