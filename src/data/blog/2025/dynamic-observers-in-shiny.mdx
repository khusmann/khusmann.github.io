...
<ShinyPortal
  url="https://khusmann.github.io/shiny-dynamic-observers/attempt1/index.html"
  client:only="react"
/>
...
<ShinyPortal
  url="https://khusmann.github.io/shiny-dynamic-observers/attempt2/index.html"
  client:only="react"
/>
...
Here, `appendMessage()` will simply add a line of text to a log container I added to the app (check out the source if you're interested in the implementation). Now, we can keep track of every time the `observeEvent()` is run:

<ShinyPortal
  url="https://khusmann.github.io/shiny-dynamic-observers/attempt2_dbg/index.html"
  client:only="react"
/>
...
<ShinyPortal
  url="https://khusmann.github.io/shiny-dynamic-observers/attempt3/index.html"
  client:only="react"
/>
...
<ShinyPortal
  url="https://khusmann.github.io/shiny-dynamic-observers/solution/index.html"
  client:only="react"
/>
