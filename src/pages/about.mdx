...
<Image
  class="float-right ml-4 hidden rounded-2xl object-cover shadow-lg sm:block"
  src={profile_pic}
  alt="Profile Picture"
  width="245"
/>
...
I'm currently a **Software Engineer** on the **Workbench team** at [**Posit**](https://posit.co/), where I work on the infrastructure that data science teams use to collaborate at scale.
...
As an undergrad, I majored in Electrical Engineering and minored in Computer Science, and spent my summers at NASA Ames working on computer vision research with the [Intelligent Robotics Group](https://www.nasa.gov/intelligent-systems-division/autonomous-systems-and-robotics/intelligent-robotics-group/).
...
That's what brought me to where I am today! Working on Posit Workbench, I get to help build tooling that data scientists and researchers across many domains rely on every day -- and contribute to the broader open source ecosystem around it.
